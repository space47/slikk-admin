export const offersFormList = [
    ...
    { name: 'min_order_quantity', label: 'Min Order Quantity', type: 'number', required: false },
    { name: 'max_order_quantity', label: 'Max Order Quantity', type: 'number', required: false },
