...
export const InitialValues = (productData: any, segmentOptions: string[] | undefined) => ({
    ...
    is_subscribed: productData?.is_subscribed || false,
    is_exchangeable: productData?.is_exchangeable || false,
    is_volumetric: productData?.is_volumetric || false,
    is_wish_listed: productData?.is_wish_listed || false,
