    ...
    return (
        ...
        >
            <div className="flex items-center justify-center gap-5 mb-6">
                <span className={`font-medium transition-colors text-xl ${!switchType ? 'text-red-500 font-semibold' : 'text-gray-400'}`}>
                    Return
                </span>
                ...
                <div className="relative">
                    <Switch
                        checked={switchType}
                        onChange={(checked) => setSwitchType(checked)}
                        className={`${
                            switchType ? 'bg-green-500' : 'bg-red-500'
                        } relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-300`}
                    />
                </div>

                <span className={`font-medium transition-colors text-xl ${switchType ? 'text-green-500 font-semibold' : 'text-gray-400'}`}>
                    Exchange
                </span>
            </div>
                                        ...
                                        <div key={pdts.id} className="mb-8">
                                            <div className="bg-white shadow-md rounded-lg p-6">
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-6 gap-6 items-center">
                                                    ...
                                                    <div className="font-semibold text-gray-600 sm:col-span-1 text-center sm:text-left">
                                                        PRODUCT NAME
                                                        <div className="sm:col-span-2 text-center sm:text-left font-normal">
                                                            {pdts.name}
                                                        </div>
                                                    </div>
            ...
            {switchType === true && <Exchange row={product} invoice_id={invoice_id} setIsOpen={setIsOpen} />}
        </Drawer>
    )
}
