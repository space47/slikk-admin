...
import { updateBoardMembers, closeDialog, useAppDispatch, useAppSelector } from '../store'
...
const AddNewMemberContent = () => {
    ...
    return (
        <div>
            ...
            <Input ref={inputRef} prefix={<HiOutlineSearch className="text-lg" />} placeholder="Quick search member" onChange={onSearch} />
            <div className="mt-4">
