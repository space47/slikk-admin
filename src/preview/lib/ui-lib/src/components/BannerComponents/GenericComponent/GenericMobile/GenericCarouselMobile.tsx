    ...
    return (
        ...
        >
            <CustomCarousel
                ...
                justifyValue={component_config?.carousel_autoplay ? 'flex-start' : component_config?.section_alignment || 'flex-start'} //the carousel breaks with any other value other than "flex-start" in some cases
