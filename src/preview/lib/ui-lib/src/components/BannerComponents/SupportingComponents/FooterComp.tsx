...
export const Footer: React.FC<FooterProps> = ({ footerConfig, size }) => {
    ...
    const footerAlign = footerPosition === 'center' ? 'justify-center' : footerPosition === 'right' ? 'justify-end' : 'justify-start'
    ...
    return (
        ...
        >
          ...
          />
                    ...
                    {((size === 'lg' && (webFooterText || footerText)) || (size !== 'lg' && footerText)) && (
                        <h1
                            className={`${footerTextStyle} `}
                            style={{
                                fontSize: `${size == 'lg' ? footerFontSizeWeb || 24 : footerFontSize || 18}px`,
                                color: footerFontColor || '#A5A4A5',
                            }}
                        >
