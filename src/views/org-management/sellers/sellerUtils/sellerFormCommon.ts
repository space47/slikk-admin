...
export const BusinessDetails = [
    ...
    { label: 'Sole Proprietorship Type', name: 'sp_type', type: 'text', isRequired: true, visible: true },
...
export const PocDetails = [
    ...
    { label: 'Finance Contact Name', name: 'finance_name', type: 'text', isRequired: true, visible: true },
    { label: 'Finance Contact Number', name: 'finance_contact_number', type: 'text', isRequired: true, visible: true },
    { label: 'Finance Email', name: 'finance_email', type: 'text', isRequired: true, visible: true },
]
...
export const SellerBankData = [
    ...
    { label: 'IFSC Code', name: 'ifsc', type: 'text', isRequired: true, visible: true },
    { label: 'Account Type', name: 'account_type', type: 'text', isRequired: true, visible: true },
]
...
export const SellerMsMeArray = [
    { label: 'MsMe Category', name: 'msme_category', type: 'text', isRequired: true, visible: true },
    { label: 'Is Registered Under MsMe', name: 'is_msme', type: 'checkbox', isRequired: true, visible: true },
]
