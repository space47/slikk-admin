...
interface GridCarouselProps<T, P> extends POSITION_ITEM_FRONTEND {
    ...
    heartOnClick?: (product: SingleProductProps, h: boolean, setH: React.Dispatch<React.SetStateAction<boolean>>) => void
}

export const GridCarousel = <T, P>({
    component_config,
    size,
    data,
    RenderCard,
    ...
    return (
        ...
        >
            <CustomGridCarousel
                ...
                width={component_config?.web_width || 8}
                ...
                justifyValue={component_config?.web_section_alignment || 'flex-start'}
