define(['exports'], function (t) {
    ...
    function x(t) {
        return t !== IDBDatabase.prototype.transaction || 'objectStoreNames' in IDBTransaction.prototype
            ? (m || (m = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(t)
                ? function (...e) {
                      return (t.apply(I(this), e), E(R.get(this)))
                  }
                : function (...e) {
                      return E(t.apply(I(this), e))
                  }
            : function (e, ...s) {
                  const n = t.call(I(this), e, ...s)
                  return (b.set(n, e.sort ? e.sort() : [e]), E(n))
              }
    }
    function L(t) {
        return 'function' == typeof t
            ...
            : (t instanceof IDBTransaction &&
              ...
              (e = t),
              (g || (g = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some((t) => e instanceof t)
                  ? new Proxy(t, U)
                  : t)
        var e
    }
    ...
    U = ((t) => y({}, t, { get: (e, s, n) => B(e, s) || t.get(e, s, n), has: (e, s) => !!B(e, s) || t.has(e, s) }))(U)
    try {
    ...
    class T {
        ...
        async getDb() {
            return (
                this.h ||
                    (this.h = await (function (t, e, { blocked: s, upgrade: n, blocking: r, terminated: i } = {}) {
    ...
    class A {
        ...
        async fetch(t) {
            ...
            try {
                ...
                throw (
                    r && (await this.runCallbacks('fetchDidFail', { error: t, event: e, originalRequest: r.clone(), request: i.clone() })),
                    t
                )
            }
        }
        ...
        async cacheMatch(t) {
            const e = K(t)
            let s
            const { cacheName: n, matchOptions: r } = this.I,
    ...
    ;((X.defaultPrecacheCacheabilityPlugin = { cacheWillUpdate: async ({ response: t }) => (!t || t.status >= 400 ? null : t) }),
        (X.copyRedirectedCacheableResponsesPlugin = { cacheWillUpdate: async ({ response: t }) => (t.redirected ? await z(t) : t) }))
    class Y {
        constructor({ cacheName: t, plugins: e = [], fallbackToNetwork: s = !0 } = {}) {
            ;((this.F = new Map()),
                (this.H = new Map()),
                (this.$ = new Map()),
                (this.I = new X({ cacheName: f(t), plugins: [...e, new V({ precacheController: this })], fallbackToNetwork: s })),
        ...
        precache(t) {
            ;(this.addToCacheList(t),
                this.G || (self.addEventListener('install', this.install), self.addEventListener('activate', this.activate), (this.G = !0)))
        }
        addToCacheList(t) {
            const e = []
            for (const n of t) {
    ...
    ;((t.CacheFirst = class extends F {
        ...
        (t.ExpirationPlugin = class {
            ...
            J(t) {
                ...
                let e = this.Y.get(t)
                return (e || ((e = new W(t, this.X)), this.Y.set(t, e)), e)
            }
            V(t) {
                if (!this.D) return !0
                const e = this.Z(t)
...
//# sourceMappingURL=workbox-b445c9d2.js.map
