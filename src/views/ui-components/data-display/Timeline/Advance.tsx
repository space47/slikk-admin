...
const Advance = () => {
    return (
        <div className="max-w-[700px]">
            <Timeline>
                <Timeline.Item media={<TimelineAvatar className="bg-amber-500">C</TimelineAvatar>}>
                ...
                <Timeline.Item media={<TimelineAvatar src="/img/avatars/thumb-3.jpg" className="bg-amber-500" />}>
                    <p className="my-1 flex items-center">
                    ...
                    <Card className="mt-4">
                        <p>
                            Fine, Java MIGHT be a good example of what a programming language should be like. But Java applications are good
                            examples of what applications SHOULDN&apos;T be like.
                        </p>
                    </Card>
                </Timeline.Item>
                <Timeline.Item
