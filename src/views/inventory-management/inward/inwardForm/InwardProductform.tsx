...
import Inwardinfo from './Inwardinfo'
import InwardField from './InwardField'
import InwardPricingfield from './InwardPricingfield'
import InwardProductimage from './InwardProductimage'
                        ...
                        <FormContainer>
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                <div className="lg:col-span-2">
                                    <Inwardinfo touched={touched} errors={errors} />
                                    <InwardPricingfield touched={touched} errors={errors} />
                                    <InwardField touched={touched} errors={errors} values={values} />
                                </div>
                                <div className="lg:col-span-1">
                                    <InwardProductimage values={values} />
                                </div>
                            </div>
                            <StickyFooter
