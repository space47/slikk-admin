...
const UltimateDatePicker = ({ setFrom, setTo, handleDateChange, dispatch, customClass }: DATEPROPS) => {
    ...
    }, [tempRange, setFrom, setTo, dispatch, handleDateChange])
    ...
    return (
        <div className="flex gap-1 items-center">
            ...
            {showingDatePicker && (
                <Dialog isOpen={showingDatePicker} onClose={handleCloseDialog}>
                    <div className=" w-full rounded-2xl bg-white shadow-xl">
                        <div className="px-5 py-4 border-b">
                            ...
                            <p className="text-xs text-gray-500 mt-1">Choose the date range to filter your data</p>
                        </div>
                        ...
                        <div className="flex justify-end gap-3 px-5 py-4 border-t bg-gray-50 rounded-b-2xl">
                            <Button variant="reject" size="sm" onClick={handleCloseDialog}>
                                Cancel
                            </Button>

                            <Button variant="blue" size="sm" loading={applySpinner} onClick={applyCustomRange}>
                                Apply
                            </Button>
                        </div>
                    </div>
