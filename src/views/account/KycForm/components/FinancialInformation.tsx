...
import { occupationOptions, annualIncomeOptions, sourceOfWealthOptions, noTinReasonOption } from '../constants'
...
const validationSchema = Yup.object().shape({
    ...
    tin: Yup.string().when('noTin', {
        is: false,
        then: (schema) => schema.required('Please enter your Taxpayer Identification number (TIN)'),
                                ...
                                <div>
                                    ...
                                    <div className="md:grid grid-cols-2 gap-4">
                                        ...
                                        {values.noTin ? (
                                            ...
                                            >
                                                <Field type="text" autoComplete="off" name="tin" placeholder="TIN" component={Input} />
                                            </FormItem>
                                        )}
                                    </div>
                                </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="md:grid grid-cols-2 gap-4">
                                                        ...
                                                        {({ field, form }: FieldProps) => (
                                                            <Select
                                                                ...
                                                                value={countryList.filter(
                                                                    (c) => c.value === getIn(values, 'companyInformation.country'),
                                                                )}
                                                ...
                                                <FormItem
                                                    ...
                                                    invalid={
                                                        getIn(errors, 'companyInformation.addressLine1') &&
                                            ...
                                            <div className="md:grid grid-cols-2 gap-4">
                                                <FormItem
                                                    ...
                                                    invalid={
                                                        getIn(errors, 'companyInformation.addressLine2') &&
