...
export const GenericCard: React.FC<GenericCardProps> = ({
    ...
    const widthStyle: React.CSSProperties = {
        width: isCarousel
            ? '100%'
            : isGridCarousel
              ? `calc(${(component_config.web_width || 0.16) * 100}vw - ${component_config?.web_gap || 8}px)`
    ...
    return (
        <div style={widthStyle}>
            ...
            {web_name && web_name_position && web_name_position == 'top' && (
                ...
                >
                    <p className="text-white font-bold" style={{ fontSize: `${web_font_size || 16}px` }}>
                        {name}
                    </p>
                </div>
            )}
            ...
            >
                ...
                {extra_attributes?.video_web ? (
                    ...
                    <img src={size !== 'lg' ? image_mobile : image_web} className=" object-cover w-full" style={combinedStyle} />
                )}
            </a>
