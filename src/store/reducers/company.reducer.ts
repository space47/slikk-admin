...
import { USER_PROFILE_DATA, companyRequest, companyRequestFailure, companyRequestSuccess, defaultCompanyRequest } from "../types/company.types";
...
export const companyReducer = createReducer(initialState, (builder) => {
    builder.addCase(companyRequest, (state) => {
        state.loading = true;
