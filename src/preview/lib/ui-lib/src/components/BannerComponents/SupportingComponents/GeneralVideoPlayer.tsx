...
const GeneralVideoPlayer: React.FC<VideoPlayerProps> = ({ url, thumbnail, aspectRatio, radius }) => {
    ...
    return (
        ...
        >
            <div className="relative">
                {!isVideoLoaded && <img src={thumbnail} alt="Video thumbnail" className="w-full h-full object-cover" />}
                <video
                    ref={videoRef}
