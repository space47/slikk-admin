    ...
    return (
        <div>
            ...
            <FormContainer className="mt-8 grid grid-cols-2 gap-2">
                <CommonSelect asterisk label="Internal Category Head Name" name={SellerKeys.INT_POC_NAME} options={CategoryNameOptions} />
                <CommonSelect asterisk label="Internal Category Head Email" name={SellerKeys.INT_POC_EMAIL} options={CategoryMailOptions} />
                <CommonSelect
                    asterisk
