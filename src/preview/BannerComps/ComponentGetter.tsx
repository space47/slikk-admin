...
function ComponentGetter({ component_type, DefaultComponent, ...rest }: POSITION_ITEM_FRONTEND) {
    ...
    if (component_type == 'Generic') return <GenericComponent {...rest} component_type={component_type} />
