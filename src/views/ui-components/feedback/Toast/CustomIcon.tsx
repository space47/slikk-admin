...
const CustomIcon = () => {
    const notificationWithIcon = (
        <Notification title="You received a Gift!" customIcon={<HiOutlineGift className="text-2xl text-indigo-600" />}>
            Something you may like.
        </Notification>
    )

    const notificationWithAvatar = (
        <Notification title="Emily Gale" customIcon={<Avatar shape="circle" src="/img/avatars/thumb-1.jpg" />}>
