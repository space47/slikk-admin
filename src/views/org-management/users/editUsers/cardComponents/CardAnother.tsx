...
const CardAnother = ({ label, getValue, selectedValue, handleSelect, handleAdd, addedValue, handleRemove }: CARDPROPS) => {
    return (
                    ...
                    {addedValue?.map((item: any, key: any) => (
                        <div key={key} className="flex flex-col">
                            <div className="bg-gray-100 px-2 py-2 flex items-center justify-between">
                                ...
                                <button className="text-red-500 ml-2" onClick={() => handleRemove(item)}>
                                    Remove
                                </button>
                            </div>
                        </div>
