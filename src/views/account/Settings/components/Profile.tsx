...
import { HiOutlineUserCircle, HiOutlineMail, HiOutlineBriefcase, HiOutlineUser, HiCheck, HiOutlineGlobeAlt } from 'react-icons/hi'
...
const CustomSelectOption = ({ innerProps, label, data, isSelected }: OptionProps<LanguageOption>) => {
    return (
        <div
...
const CustomControl = ({ children, ...props }: ControlProps<LanguageOption>) => {
...
const Profile = ({
    ...
    const onSetFormFile = (form: FormikProps<ProfileFormModel>, field: FieldInputProps<ProfileFormModel>, file: File[]) => {
        form.setFieldValue(field.name, URL.createObjectURL(file[0]))
    }

    const onFormSubmit = (values: ProfileFormModel, setSubmitting: (isSubmitting: boolean) => void) => {
        ...
        >
            {({ values, touched, errors, isSubmitting, resetForm }) => {
                ...
                return (
                    <Form>
                        <FormContainer>
                            <FormDesription title="General" desc="Basic info, like your name and address that will displayed in public" />
