...
function LoyaltyBanner() {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <a
        href={"#"}
        className="bg-[#450029] py-2 text-[14px] w-full flex flex-row items-center justify-center space-x-1"
      >
        <span className="text-center text-primaryWhite text-opacity-50">
          Learn more about our membership programme
        </span>
        <div>
          <svg
            width="14"
