...
const ProductTypeEdit = () => {
    ...
    const handleSubmit = async (values: any) => {
        ...
        const body = {
            ...
            category: Array.isArray(values.category) ? values?.category[0]?.id : values?.category || '',
            sub_category: Array.isArray(values.sub_category) ? values?.sub_category[0]?.id : values?.sub_category || '',
