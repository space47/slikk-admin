        ...
        <div className="flex gap-8">
            ...
            <div className="ltr:ml-2 rtl:mr-2">
                <div className="mb-2 text-[14px] font-bold">
                    Brand Name:
                    <h4 className="font-light text-[12px] truncate whitespace-nowrap">{row.brand}</h4>
                </div>
                <div className="mb-2 text-[14px] font-bold">
                    Product Name:
                    <h4 className="font-light text-[12px] truncate whitespace-nowrap">{row.name}</h4>
                </div>
...
const PendingProduct = ({ data = [] }: OrderProductsProps) => {
