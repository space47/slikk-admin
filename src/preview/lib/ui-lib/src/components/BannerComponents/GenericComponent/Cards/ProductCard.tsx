    ...
    return (
        <div className={`flex flex-col h-fit  ${inventory_count == 0 && 'opacity-80'}  `} style={combinedStyle}>
            ...
            <a
                ...
                style={widthStyle}
            >
                <img src={image} loading="lazy" className={`  object-cover object-top  w-full h-full`} style={cornerRadiusStyle} />
                <div
            ...
            <div
                className={`flex flex-row justify-between items-start w-full text-[13px] h-[25%] ${TextVariants({ type })}`}
                style={{
