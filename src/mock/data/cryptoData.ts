export const portfolioData = {
    ...
    overviewData: {
        ...
        date: ['01 Jan', '02 Jan', '03 Jan', '04 Jan', '05 Jan', '06 Jan', '07 Jan', '08 Jan', '09 Jan', '10 Jan', '11 Jan', '12 Jan'],
    },
    recentAcivity: [
        {
            date: 'June 3, 2022',
            ...
            series: [
                {
                    name: 'Porfolio Balance',
                    data: [
                        20874.12, 26583.56, 23943.65, 24453.84, 22473.43, 29185.37, 27815.48, 36834.69, 32422.11, 35888.32, 32112.84,
                        38764.22,
                    ],
                },
            ],
            timeRange: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
        },
    },
    recentAcivityData: [
        {
